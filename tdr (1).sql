...
CREATE TABLE `course_material` (
  ...
  `MATERIAL_ID` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '资料编号',
  `COURSE_ID` varchar(32) DEFAULT NULL COMMENT '课程编号',
  `MATERIAL_PATH` varchar(200) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '资料路径',
...
-- ----------------------------
INSERT INTO `course_material` VALUES ('oakCenter1.png', '1oakCenter1.png', '1', 'H:\\课设一\\TDR\\xttdr\\backend\\tdr/files/1oakCenter1.png', 'teacher', '2021-09-08 22:47:29');
...
INSERT INTO `user` VALUES ('student', 'S0', 'sss', '1');
INSERT INTO `user` VALUES ('teacher', 'T0', 'ttt', '1');
